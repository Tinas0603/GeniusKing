...
const MASTER_URL =
  "https://api-ap-southeast-2.hygraph.com/v2/clum6pwow0e3607tbjmo4tkmt/master";
...
export const enrollCourse=async(courseId,userEmail)=>{
  ...
  mutation MyMutation {
    createUserEnrolledCourse(data: {courseId: "`+courseId+`", userEmail: "`+userEmail+`",course: {connect: {id: "`+courseId+`"}}}
    ) {
      id
    }
