    ...
    >
      ...
      <View style={{ padding: 10 }}>
        ...
        <View>
          ...
          <Text style={{fontFamily: "outfit",color:Colors.GRAY,lineHeight:23}}>{course?.description?.markdown}</Text>
        </View>
        <View style={{display: "flex",flexDirection: "column",justifyContent:'space-evenly',gap:20}}>
        {userEnrolledCourse?.length == 0 ?<TouchableOpacity 
          onPress={()=>enrollCourse()}
          style = {{padding:15,backgroundColor:Colors.PRIMARY,
          borderRadius:10}}>
            <Text style={{fontFamily:'outfit',color:Colors.WHITE,textAlign:'center',fontSize:15}}>Enroll Course</Text>
          </TouchableOpacity>:null}
          {/* <TouchableOpacity style = {{padding:15,backgroundColor:Colors.SECONDARY,
          borderRadius:15}}>
            <Text style={{fontFamily:'outfit',color:Colors.WHITE,textAlign:'center',fontSize:17}}>Membership 60.000 đ/Month</Text>
          </TouchableOpacity> */}
        </View>
      </View>
    </View>
